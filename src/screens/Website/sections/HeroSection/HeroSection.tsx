...
export const HeroSection = (): JSX.Element => {
  return (
    <section id="hero" className="relative w-full h-auto min-h-[1058px] rotate-180 overflow-hidden bg-[#0c0c0c]">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[1058px] px-4 py-20 pt-[calc(3.5rem+1vh)] -rotate-180">
        <div className="-translate-y-[8vh]">
          ...
          >
            ...
            <span className="[font-family:'Inter',Helvetica] font-normal text-white text-[11.94px] tracking-[0.36px] leading-[17.91px] whitespace-nowrap">
          ...
          <div className="flex flex-col items-center gap-5 [--animation-delay:200ms] translate-y-[-1rem] animate-fade-in opacity-0">
            <h1 className="flex flex-wrap items-center justify-center gap-5">
              <span className="[font-family:'Poppins',Helvetica] font-bold text-white text-[78px] tracking-[-2.65px] leading-[81.69px] whitespace-nowrap">
                We Build Brands
              </span>
            </h1>
            ...
            <h2 className="flex flex-wrap items-center justify-center gap-5">
              ...
              <span className="[font-family:'Poppins',Helvetica] font-bold text-white text-[78px] tracking-[-1.00px] leading-[81.69px] whitespace-nowrap">
                Feel Inevitable.
              </span>
            </h2>
          </div>

          <p className="w-full max-w-[883px] [font-family:'Inter',Helvetica] font-medium text-[#dddddd] text-[17.91px] text-center tracking-[0] leading-[25.87px] [--animation-delay:400ms] translate-y-[-1rem] animate-fade-in opacity-0">
          ...
          <div className="flex items-center justify-between h-[58px] w-full max-w-[571px] gap-4 bg-[#000000ab] rounded-full border border-[#ffffff0f] shadow-[inset_0px_4px_4px_#000000] pl-6 pr-[0.5%] [--animation-delay:600ms] translate-y-[-1rem] animate-fade-in opacity-0">
            <span className="[font-family:'Space_Grotesk',Helvetica] font-medium text-[#ffffffc9] text-[13.93px] tracking-[0.13px] leading-[19.40px] whitespace-nowrap">
