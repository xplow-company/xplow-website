...
export const PhilosophySection = (): JSX.Element => {
  return (
    <section id="philosophy" className="w-full min-w-0 overflow-hidden">
      {/* Trusted by forward-thinking brands — logo row */}
      <div id="logo-section" className="w-full bg-white py-5 md:py-14">
        <div className="container mx-auto px-5 md:px-5 lg:px-16 max-w-[1562px] flex flex-col items-center gap-10 translate-y-[-1rem] animate-fade-in opacity-0" style={{ "--animation-delay": "0ms" } as React.CSSProperties}>
      ...
      <div className="w-full bg-[#111111] py-5 md:py-20">
