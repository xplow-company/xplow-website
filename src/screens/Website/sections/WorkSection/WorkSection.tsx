        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 md:gap-7 lg:gap-8 translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:150ms]">
          ...
          >
            <div className="absolute inset-0">
              ...
              <div className="absolute inset-0 bg-[#ff1f4f]/0 group-hover:bg-[#ff1f4f]/[0.03] transition-colors duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]" />
            </div>
            <div className="absolute top-6 right-6 w-12 h-12 rounded-full bg-white/[0.08] backdrop-blur-md flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-110 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 border border-white/[0.12] shadow-lg delay-75">
              <ArrowUpRight className="w-5 h-5 text-white" />
            </div>
            <div className="absolute bottom-0 left-0 right-0 p-8 md:p-10 lg:p-14 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-y-[-2px]">
              ...
              <h3 className="[font-family:'Poppins',Helvetica] font-bold text-white text-[32px] md:text-[40px] lg:text-[48px] tracking-[-1.5px] leading-[1.06] group-hover:text-[#ff1f4f] transition-colors duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] drop-shadow-sm">
          ...
          >
            ...
            <div className="absolute top-5 right-5 w-10 h-10 rounded-full bg-white/[0.08] backdrop-blur-md flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-110 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 border border-white/[0.12] shadow-lg delay-75">
              <ArrowUpRight className="w-4 h-4 text-white" />
            </div>
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-y-[-2px]">
              ...
              <h3 className="[font-family:'Poppins',Helvetica] font-bold text-white text-[22px] md:text-[26px] tracking-[-0.5px] group-hover:text-[#ff1f4f] transition-colors duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] drop-shadow-sm">
          ...
          {workProjects.slice(3, 6).map((project) => (
            ...
            >
              ...
              <div className="absolute top-4 right-4 w-9 h-9 rounded-full bg-white/[0.08] backdrop-blur-md flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-110 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 border border-white/[0.12] shadow-lg delay-75">
                <ArrowUpRight className="w-3.5 h-3.5 text-white" />
              </div>
              <div className="absolute bottom-0 left-0 right-0 p-5 md:p-6 min-w-0 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-y-[-2px]">
                ...
                <h3 className="[font-family:'Poppins',Helvetica] font-bold text-white text-[18px] md:text-[20px] tracking-[-0.4px] group-hover:text-[#ff1f4f] transition-colors duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] break-words drop-shadow-sm">
                  {project.title}
                </h3>
